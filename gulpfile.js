...
// gulp jsBandle (Move the jquery and picturefill javascript files into our /vendor folder)
function jsBandle () {
  return src([
    'node_modules/jquery/dist/jquery.slim.min.js',
    'node_modules/picturefill/dist/picturefill.min.js'
  ])
    .pipe(dest('source/vendor'));
}
...
exports.start = series(css, jsBandle, js, server);
exports.build = series(parallel(css, jsBandle, js), clean, copy);
